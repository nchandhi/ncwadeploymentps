...
resource PostgresServerNameEntry 'Microsoft.KeyVault/vaults/secrets@2021-11-01-preview' = {
  parent: keyVault
...
resource PostgresDbNameEntry 'Microsoft.KeyVault/vaults/secrets@2021-11-01-preview' = {
  parent: keyVault
...
resource PostgresDbUserEntry 'Microsoft.KeyVault/vaults/secrets@2021-11-01-preview' = {
  parent: keyVault
  name: 'POSTGRESQL-USER'
  properties: {
    value: postgresqlDbUser
  }
}

resource PostgresDbPwdEntry 'Microsoft.KeyVault/vaults/secrets@2021-11-01-preview' = {
  parent: keyVault
  name: 'POSTGRESQL-PASSWORD'
  properties: {
    value: postgresqlDbPwd
  }
}

resource PostgresSslModeEntry 'Microsoft.KeyVault/vaults/secrets@2021-11-01-preview' = {
  parent: keyVault
  name: 'SSLMODE'
  properties: {
    value: sslMode
